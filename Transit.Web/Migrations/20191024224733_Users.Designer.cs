...
namespace Transit.Web.Migrations
{
    ...
    [Migration("20191024224733_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transit.Web.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Transit.Web.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Transit.Web.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("Transit.Web.Data.Entities.Agent", b =>
                {
                    b.HasOne("Transit.Web.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
